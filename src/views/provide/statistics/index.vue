<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column label="接口路径" align="center" prop="path" width="300px"></el-table-column>
      <el-table-column label="接口名称" align="center" prop="name" width="220px"></el-table-column>
      <el-table-column label="接口描述" align="center" prop="desc" width="220px"></el-table-column>
      <el-table-column label="用户名称" align="center" prop="username"></el-table-column>
      <el-table-column label="请求时间" align="center" prop="created_at" width="160px"></el-table-column>
